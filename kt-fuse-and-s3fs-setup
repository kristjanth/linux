...
S3_CACHE_PATH="/tmp/s3cache"
FUSE_URL="http://downloads.sourceforge.net/project/fuse/fuse-2.X/2.9.3/fuse-2.9.3.tar.gz"
FUSE_PATH="/usr/src/fuse"
S3FS_URL="https://s3fs.googlecode.com/files/s3fs-1.74.tar.gz"
S3FS_PATH="/usr/src/s3fs"

# Do not change anything below this

yum remove -y -q fuse fuse-s3fs &> /dev/null
yum install -y -q gcc libstdc++-devel gcc-c++ curl-devel libxml2-devel openssl-devel mailcap &> /dev/null
...
s3fs -o use_cache=$S3_CACHE_PATH $AWS_S3BUCKET $S3_MOUNT_PATH &> /dev/null
